  ...
  return (
    <>
      <div
        className={`${
          className ? className : ""
        } text-white bg-[#1e3238] grid lg:grid-cols-2 gap-8 px-8 py-6 lg:px-14`}
      >
        {/* Logo and map */}
        <div className="grid  md:grid-cols-2 lg:grid-cols-2 gap-4 ">
          ...
          {/* Dexterix Image */}
          <LazyLoadImage
            src="/SIHP Logo White.png"
            className="w-44 py-8 md:py-28  lg:py-20"
            alt="logo"
          />

          {/*Map*/}
          <div className="">
            <h4 className="mb-4 font-bold text-[#f6921e] border-b-2 border-[#f6921e] w-8">
              VENUE
            </h4>
            <iframe
              width="200"
        ...
        <div className="row grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:mt-2">
          {/*<div className="col">
            <h4 className="font-bold text-[#f6921e]">Resources</h4>
            <div className=" w-14 bg-[#f6921e] h-[1.5px] mb-2"></div>
            ...
            <ul>
              ...
              <li className="hover:pl-3 transition-all duration-150 ease-linear text-gray-400 cursor-pointer hover:text-[#f6921e]">
                <a href="https://docs.google.com/document/d/1TCLGJTBX8hFmCkcjS8MfHPS12GZqhAwwx5VFVyUrH6I/edit?usp=sharing">
                  Code Of Conduct
                </a>
              </li>
            </ul>
          ...
          <div className="col">
            {/* <<<<<<< HEAD */}
            <h4 className="font-bold text-[#f6921e] ">COMMUNITY</h4>
            <div className=" w-14 bg-[#f6921e] h-[1.5px] mb-2"></div>

            <ul>
              <a href="https://github.com/technojam" target="_blank">
                <li className="flex gap-2 items-center hover:pl-3 transition-all duration-150 ease-linear text-gray-400 cursor-pointer hover:text-[#f6921e]">
                  Github
              ...
              <a href="https://t.me/+2Nl-Md27pXkwNjI1" target="_blank">
                <li className="flex gap-2 items-center hover:pl-3 transition-all duration-150 ease-in-out text-gray-400 cursor-pointer hover:text-[#f6921e]">
                  Telegram
          ...
          <div className="col">
            {/* <<<<<<< HEAD */}
            <h4 className="font-bold text-[#f6921e] ">Archives</h4>
            <div className=" w-12 bg-[#f6921e] h-[1.5px] mb-2"></div>

            <ul>
              <a
                href="https://www.instagram.com/p/B5ZB_tbnaVw/?img_index=1"
                target="_blank"
              >
                <li className="hover:pl-3 transition-all duration-150 ease-linear text-gray-400 cursor-pointer hover:text-[#f6921e]">
                  Dexterix 2.0
              ...
              <a
                href="https://www.instagram.com/p/CgCTkF2MAM9/?img_index=1"
                target="_blank"
              >
                <li className="hover:pl-3 transition-all duration-150 ease-linear text-gray-400 cursor-pointer hover:text-[#f6921e]">
                  Dexterix 3.0
              ...
              <a
                href="https://www.instagram.com/p/CjNY8ypvmeX/?img_index=1"
                target="_blank"
              >
                <li className="hover:pl-3 transition-all duration-150 ease-linear text-gray-400 cursor-pointer hover:text-[#f6921e]">
          ...
          <div className="col">
            {/* <<<<<<< HEAD */}
            <h1 className="font-bold text-[#f6921e] ">Social Connection</h1>
            <div className=" w-28 bg-[#f6921e] h-[1.5px] mb-2"></div>
            <p className="text-gray-400">Learn. Teach. Hack. Win</p>

            <ul className="flex gap-3 py-4 ">
              <li className="hover:scale-110  duration-150 text-2xl text-[#f6921e]">
                <a
      ...
      <div
        className="
      text-center pt-2 w-full  text-gray-400 text-sm pb-4 bg-gray-900"
      >
