...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="px-5 overflow-x-hidden w-screen   z-30 text-white gap-8 absolute top-0 left-0 h-[11vh] bg-transparent flex items-center justify-between navbar">
        {/* Technojam Logo */}
        ...
        <div className="hidden lg:flex text-xl backdrop-blur text-sh bg-white px-12 py-4 rounded-lg bg-opacity-25 items-center gap-8 font-Gugi_sans-serif mr-10">
          <a
            href="#about"
      ...
      <div
        className={`${
          sidebar ? "top-0 right-0" : "top-0 right-[-400px] hidden"
