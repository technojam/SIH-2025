    ...
    >
      <div className="absolute lg:left-1/2 left-0 top-20">
        <motion.div
          ...
          className="ml-[27px] h-4 w-4 rounded-full border border-netural-200 shadow-sm flex items-center justify-center text-[#f6921e]"
        >
          <motion.div
            transition={{
              duration: 0.2,
      ...
      >
        <h1 className="text-4xl font-semibold underline underline-offset-4 text-center w-full text-[#f6921e]"
        ...
        <div className="flex flex-col gap-14 items-end md:items-start lg:items-end mt-5 md:ml-20 lg:ml-0">
          <div className="flex lg:items-center gap-28 ml-12 items-start lg:flex-row flex-col">
            <div
              className="w-[260px] leftBox resBox rounded px-4 py-2 lg:p-3 flex justify-between items-center bg-gradient-to-r from-[#3fcb9c] to-[#6cb6cf]"
            > 
          ...
          <div className="flex lg:items-center gap-28 ml-12 items-start lg:flex-row flex-col-reverse">
            ...
            <div
              ...
              className="w-[260px] rightBox resBox rounded px-4 py-2 lg:p-3 flex justify-between items-center bg-gradient-to-r from-[#3fcb9c] to-[#6cb6cf]"
            >
              <h6 className="font-bold text-xl hover:text-xl">Registration Ends</h6>
              <FaWalking />
            </div>
          </div>
          <div className="flex lg:items-center gap-28 ml-12 items-start lg:flex-row flex-col">
          ...
          <div className="flex lg:items-center resBox gap-28 ml-12 items-start lg:flex-row flex-col-reverse">
            ...
            <div
              ...
              className="w-[280px] rightBox resBox rounded px-4 py-2 lg:p-3 flex justify-between items-center bg-gradient-to-r from-[#3fcb9c] to-[#6cb6cf]"
            >
          ...
          <div className="flex lg:items-center gap-28 ml-12 items-start lg:flex-row flex-col">
            <div
              ...
              className="w-[320px] leftBox resBox rounded px-4 py-2 lg:p-3 flex justify-between items-center bg-gradient-to-r from-[#3fcb9c] to-[#6cb6cf]"
            >
              <h6 className="font-bold text-xl hover:text-xl">
                Winner Announcement
              </h6>
