...
const Judges = ({ heading, lists }) => {
  return (
    <div className="min-h-screen flex lg:py-28 py-16 text-white lg:w-10/12 mx-auto flex-wrap items-center justify-evenly  gap-10 lg:gap-20 relative">
      <h1 className="absolute  text-[#f6921e] lg:top-2 top-0 text-4xl font-semibold">
        {heading}
      </h1>
      {lists.map((list)=><div key={list.name} className="lg:w-1/6 md:w-1/3 w-10/12 lg:h-[440px] h-[360px] flex flex-col items-center justify-between">
        ...
        <a
          ...
          className="hover:scale-110 hover:text-[#f6921e] text-xl duration-150"
          target="_blank"
        >
          <FaLinkedinIn />
        </a>
